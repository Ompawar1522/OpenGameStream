...
public sealed partial class TurnServerEditorVm : ObservableObject
{
    ...
    public string Title => IsReadOnly ? "TURN server (Read only)" : "TURN server";

    private readonly TurnServerConfig? _existing;
    private Window? _window;

    public TurnServerEditorVm(TurnServerConfig? existing)
    {
        _existing = existing;
